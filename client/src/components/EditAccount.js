                                                ...
                                                <div className="post">
                                                    <div className="user-block">
                                                        <img className="img-circle img-bordered-sm"
                                                             src="../../dist/img/user1-128x128.jpg" alt="user" />
                        ...
                        <span className="username">
                          ...
                          <a href="#" className="float-right btn-tool"><i className="fas fa-times"></i></a>
                                                ...
                                                <div className="post">
                                                    <div className="user-block">
                                                        <img className="img-circle img-bordered-sm"
                                                             src="../../dist/img/user6-128x128.jpg" alt="User"/>
                        <span className="username">
                          <a href="#">Adam Jones</a>
                          <a href="#" className="float-right btn-tool"><i className="fas fa-times"></i></a>
                        </span>
                                                            ...
                                                            <div className="row">
                                                                <div className="col-sm-6">
                                                                    <img className="img-fluid mb-3"
                                                                         src="../../dist/img/photo2.png" alt="Profile" />
                                                                ...
                                                                <div className="col-sm-6">
                                                                    <img className="img-fluid mb-3"
                                                                         src="../../dist/img/photo4.jpg" alt="profile" />
                                                                        <img className="img-fluid"
                          ...
                          10 Feb. 2014
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="timeline-item">
                                                            ...
                                                            <div className="timeline-body">
                                                                <img src="http://placehold.it/150x100" alt="profile" />
                                                                    <img src="http://placehold.it/150x100" alt="profile" />
