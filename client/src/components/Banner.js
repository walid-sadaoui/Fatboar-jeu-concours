                ...
                <div className="intro-container">
                    ...
                    <div className="carousel-item active">
                        ...
                        <img className="img-fluid wow fadeInUp" src={RangeRover} alt="" width="420"/>
                            <h2 className="wow fadeInUp" data-wow-delay="0.1s">ET SI C'ÉTAIT VOUS L'HEUREUX GAGNANT ?                                                               </h2>
                            <h3 className="wow fadeInUp" data-wow-delay="0.1s"><strong>Gagnez un Range Rover et bien d'autres lots</strong></h3>
                            <a href="#jeu-concours" className="btn-get-started scrollto wow fadeInUp hvr-grow" data-wow-delay="0.1s">JOUEZ DÈS MAINTENANT</a>
                        </div>
                        </div>
                    </div>
                    </div>
