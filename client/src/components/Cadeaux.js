...
import TitreCadeaux from '../assets/img/titres/cadeaux.png';
import RangeRover from '../assets/img/2020-rangeOver.jpg';
import Burger from '../assets/img/2020-burger.webp';
import MenuJour from '../assets/img/2020-menu-jour.webp';
import MenuChoix from '../assets/img/2020-menu-choix.webp';
import Dessert from '../assets/img/2020-dessert.jpeg';
import Remise from '../assets/img/2020-pourcentage.jpg';
                ...
                <img src={TitreCadeaux} alt="" width="510px" class="img-fluid wow fadeInUp"/>
                    ...
                    <div className="row">
                            <div className="col-md-4 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="card">
                                    <img class="card-img-top" src={RangeRover} alt="Card cap"/>
                                    <div class="card-body">
                            ...
                            <div className="col-md-4 wow fadeInUp" data-wow-delay="0.2s">
                                <div class="card">
                                    <img class="card-img-top" src={Burger} alt="Card cap"/>
                                    <div class="card-body">
                            ...
                            <div className="col-md-4 wow fadeInUp" data-wow-delay="0.3s">
                                <div class="card">
                                    <img class="card-img-top" src={MenuJour} alt="Card cap"/>
                                    <div class="card-body">
                            ...
                            <div className="col-md-4 wow fadeInUp" data-wow-delay="0.4s">
                                <div class="card">
                                    <img class="card-img-top" src={MenuChoix} alt="Card cap"/>
                                    <div class="card-body">
                            ...
                            <div className="col-md-4 wow fadeInUp" data-wow-delay="0.5s">
                                <div class="card">
                                    <img class="card-img-top" src={Dessert} alt="Card cap"/>
                                    <div class="card-body">
                            ...
                            <div className="col-md-4 wow fadeInUp" data-wow-delay="0.6s">
                                <div class="card">
                                    <img class="card-img-top" src={Remise} alt="Card cap"/>
                                    <div class="card-body">
